...
export class init1683465374114 implements MigrationInterface {
    name = 'init1683465374114'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`commentImage\` DROP COLUMN \`url\``);
        await queryRunner.query(`ALTER TABLE \`commentImage\` ADD \`url\` varchar(300) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`comment\` DROP COLUMN \`content\``);
        await queryRunner.query(`ALTER TABLE \`comment\` ADD \`content\` varchar(1000) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`article\` DROP COLUMN \`content\``);
        await queryRunner.query(`ALTER TABLE \`article\` ADD \`content\` varchar(1000) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`articleImage\` DROP COLUMN \`url\``);
        await queryRunner.query(`ALTER TABLE \`articleImage\` ADD \`url\` varchar(400) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`articleImage\` DROP COLUMN \`url\``);
        await queryRunner.query(`ALTER TABLE \`articleImage\` ADD \`url\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`article\` DROP COLUMN \`content\``);
        ...
        await queryRunner.query(`ALTER TABLE \`commentImage\` DROP COLUMN \`url\``);
        await queryRunner.query(`ALTER TABLE \`commentImage\` ADD \`url\` varchar(255) NOT NULL`);
